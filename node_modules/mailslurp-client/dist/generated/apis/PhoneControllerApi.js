...
var PhoneControllerApi = /** @class */ (function (_super) {
     ...
     * Get a phone number by name
     */
    PhoneControllerApi.prototype.getPhoneNumberByNameRaw = function (initOverrides) {
        return __awaiter(this, void 0, void 0, function () {
            var queryParameters, headerParameters, response;
            return __generator(this, function (_a) {
                switch (_a.label) {
     ...
     * Get a phone number by name
     */
    PhoneControllerApi.prototype.getPhoneNumberByName = function (initOverrides) {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.getPhoneNumberByNameRaw(initOverrides)];
                    case 1:
                        response = _a.sent();
                        return [4 /*yield*/, response.value()];
                    case 2: return [2 /*return*/, _a.sent()];
     ...
     * Get a phone number by phone number
     */
    PhoneControllerApi.prototype.getPhoneNumberByPhoneNumberRaw = function (initOverrides) {
        return __awaiter(this, void 0, void 0, function () {
            var queryParameters, headerParameters, response;
            return __generator(this, function (_a) {
                switch (_a.label) {
     ...
     * Get a phone number by phone number
     */
    PhoneControllerApi.prototype.getPhoneNumberByPhoneNumber = function (initOverrides) {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.getPhoneNumberByPhoneNumberRaw(initOverrides)];
                    case 1:
                        response = _a.sent();
                        return [4 /*yield*/, response.value()];
                    case 2: return [2 /*return*/, _a.sent()];
